public class FractionRunner
{
    public static void main(String[] args)
    {
        ...
        double srslyWTFdoesThisDo = Fraction.multiplyFractions(frac9, (frac9.largerFraction(frac10).multiplyWithFraction(new Fraction(6, 4)).largerFraction(frac9))).asDecimal();
